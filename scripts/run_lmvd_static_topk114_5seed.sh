...
for seed in 9 42 2024 7 123
do
  echo "============================================================"
  echo "Static top-k graph | k=114 | seed=${seed}"
  echo "============================================================"
  ...
  python main_lmvd.py \
    ...
    --save-dir ./ckpt_lmvd \
    --model-name hypervd_lmvd_seq300_detour_a05_statictopk114_seed${seed} \
    --visual-dim 465 \
    --audio-dim 128 \
    --visual-proj-dim 128 \
    --audio-proj-dim 128 \
    ...
    --cuda "${CUDA_ID}" \
    2>&1 | tee \
      logs_lmvd/hypervd_lmvd_seq300_detour_a05_statictopk114_seed${seed}.log
done
