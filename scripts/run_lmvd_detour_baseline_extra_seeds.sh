...
do
  echo "============================================================"
  echo "Detour baseline | seed=${seed}"
  echo "============================================================"
  ...
  python main_lmvd.py \
    ...
    --save-dir ./ckpt_lmvd \
    --model-name hypervd_lmvd_seq300_detour_a05_selauprc_thrf1weighted_seed${seed} \
    --visual-dim 465 \
    --audio-dim 128 \
    --visual-proj-dim 128 \
    --audio-proj-dim 128 \
    ...
    --seed ${seed} \
    --cuda "${CUDA_ID}" \
    2>&1 | tee logs_lmvd/hypervd_lmvd_seq300_detour_a05_selauprc_thrf1weighted_seed${seed}.log
done
